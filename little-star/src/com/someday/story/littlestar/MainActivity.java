package com.someday.story.littlestar;
...
import com.someday.story.littlestar.util.AudioUtils;
...
public class MainActivity extends Activity implements OnGestureListener {
    ...
    private static final long MIN_ACTION_DELAY = 300; 
    private static final long ACCELETE_ACTION_DELAY = 3000; 
    private static final int MIN_ACTION_X_DISTANCE = 160; 
    private static final int MIN_ACTION_Y_DISTANCE = 80; //
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mp = getMediaPlayer(R.raw.little_star);
